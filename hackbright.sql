...
1	Markov	Tweets generate from Markov chains	50
2	Blockly	Programmatic Logic Puzzle Game	10
3	Shopping-site	HTML+CSS+FLASK, oh my!	60
5	Madlib	Using Jinja to create a madlib site	40
4	Calculator	functions that can handle preset calculations	30
\.
